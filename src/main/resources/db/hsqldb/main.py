...
place=['北京', '上海', '广州','合肥', '晋中', '杭州', '咸阳', '西安', '珠海', '成都', '南京', '长沙', '杭州']
department=['软件工程', '计算机科学与技术', '哲学','数学', '汉语言文学', '行政管理', '历史']


place=['beijing', 'shanghai', 'guangzhou','hefei', 'jinzhong', 'hangzhou', 'xianyang', 'xian', 'zhuhai', 'chengdu', 'nanjing', 'changsha', 'hangzhou']
department=['software', 'computer', 'math','history', 'philosophy', 'administration']
...
for i in range(10000):
    ...
    nian=random.randint(0,10)
    yue=random.randint(1,13)
    ri=random.randint(1,28)
    birthday=str(1990+nian)+"-"+str(yue)+"-"+str(ri)
    res+="'"+birthday+"',"
    p=random.randint(0,len(place)-1)
    res+="'"+place[p]+"',"
    
    p=random.randint(0,len(department)-1)
    res+="'"+department[p]+"',"
